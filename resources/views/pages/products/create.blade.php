        ...
        <div class="card-body card-block">
            <form action="{{ route('products.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="ckeditor" class="form-control @error('description') is-invalid @enderror">{{ old('description') }}
                    </textarea>
                    @error('description')
                        <div class="text-muted">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-block" type="submit">Add barang</button>
                </div>
